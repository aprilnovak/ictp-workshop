...
\author{Joint ICTP-IAEA Workshop on Open-Source Nuclear Codes for Reactor Analysis \\ September 22, 2025}
%\institute{Argonne National Laboratory}
\date{}
\titlegraphic{
  \begin{picture}(0,0)
    \put(250,-220){\makebox(0,0)[rt]{\includegraphics[height=0.75cm]{../images/openmc_logo.png}}}
    \put(325,-214){\makebox(0,0)[rt]{\includegraphics[height=1.15cm]{../images/UIUC-Logo.jpg}}}
...
\begin{frame}{Interactive Sessions}
  \begin{itemize}
    \item You will be using \textbf{Google Collab} for demonstrations and
    (optionally) take-home exercises
    \item Instructor will give a live demo, and you can follow
    along in your own Google Collab instance (dual monitor / side-by-side)
    \item The URL provided to you will be available indefinitely! It is completely free to run these notebooks
    \item For efficiency once we start hands-on later, start the cross section download box now!
  \end{itemize}
\end{frame}

\begin{frame}{OpenMC Google Collab}
\begin{itemize}
\item April's sessions: \url{github.com/aprilnovak/ictp-workshop}
\item Empty notebook: \url{https://tinyurl.com/mu8fz5dm}
\item Solutions notebook: \url{https://tinyurl.com/75mmyfeh}
\end{itemize}
     \begin{center}
      \includegraphics[width=1.8in]{../images/collab.png}
    \end{center} 
\begin{itemize}\item Execute each cell with {\tt Shift + Enter}
\end{itemize}
     \begin{center}
      \includegraphics[width=1.5in]{../images/collab_success.png}
    \end{center} 
\end{frame}
...
\begin{frame}{Monte Carlo Particle Transport}
  ...
  \item Analysis of nuclear reactors, fusion devices, radiation shielding, and
    ...
    \item \emph{Deterministic methods:} discrete ordinates, method of
      characteristics, diffusion theory, $\cdots$
...
\begin{frame}{OpenMC: Overview of features}
  \begin{itemize}
    ...
    \item \textbf{Geometry}: Constructive solid geometry, CAD-based (e.g. surface meshes),
    unstructured volume mesh (coming soon)
  \end{itemize}
  \vspace{1em}
     \begin{center}
      \includegraphics[width=4in]{../images/geometry.png}
    \end{center} 
\end{frame}
...
\begin{frame}{OpenMC: Overview of features}
  \begin{itemize}
    ...
    volume calculation
    \item \textbf{Tallies}: cell tally, structured mesh tally, unstructured mesh tally
    \item \textbf{Data}: Continuous energy or multigroup cross sections,
    multipole for on-the-fly Doppler broadening
  \end{itemize}
    \vspace{1em}
     \begin{center}
      \includegraphics[width=4in]{../images/tallies.png}
    \end{center} 
\end{frame}
